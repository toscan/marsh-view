...
(function ($) {
    $.fn.uploader = function (options, testMode) {
        return this.each(function (index) {
            options = $.extend({
                submitButtonCopy: 'Upload fichiers',
                instructionsCopy: 'Drag and Drop, ou',
                furtherInstructionsCopy: '',
                selectButtonCopy: 'upload documents',
                secondarySelectButtonCopy: 'Ajouter des documents',
                dropZone: $(this),
                fileTypeWhiteList: ['jpg', 'png', 'jpeg', 'gif', 'pdf'],
                badFileTypeMessage: 'type de fichier non valide',
                ajaxUrl: '/ajax/upload',
                testMode: false
            }, options);
            ...
            var dom = {
                uploaderBox: $(this),
                submitButton: $(''),
                instructions: $('<p class="js-uploader__instructions uploader__instructions text-center">' +
                ...
                selectButton: $('<input style="height: 0; width: 0;" id="fileinput' + index + '" type="file" multiple class="js-uploader__file-input uploader__file-input">' +
                    '<label for="fileinput' + index + '" style="cursor: pointer;" class="js-uploader__submit-button uploader__submit-button"><i class="js-uploader__icon fa fa-upload uploader__icon"></i>' +
                ...
                secondarySelectButton: $('<input style="height: 0; width: 0;" id="secondaryfileinput' + index + '" type="file"' +
                    ...
                    '<label for="secondaryfileinput' + index + '" style="cursor: pointer;" class="js-uploader__submit-button uploader__submit-button">' +
